...
// sortRunes is a simple insertion sort that sorts the runes of
// given string. By sorting the unicode chars of the string (i.e. 
...
// write writes the map of anagrams to a file specified by fname.
// The use of os.OpenFile (instead of os.Create) is to demonstrate 
// the use of panic() which is generated when OpenFile returns an error
